...
const LESSONS = [
  ...
  // ==========================================
  {
    ...
    content: {
      ...
      vocab: [
        { ar: 'بؤبؤ',             en: 'Pupil',                  es: 'Pupila' },
        { ar: 'طبيب',             en: 'Doctor',                 es: 'Médico' },
        { ar: 'إبرة جراحة',       en: 'Surgical Needle',        es: 'Aguja Quirúrgica' },
        { ar: 'جهاز باسكال الليزري', en: 'Pascal Laser Device', es: 'Dispositivo Láser Pascal' },
        { ar: 'العصب البصري',     en: 'Optic Nerve',            es: 'Nervio Óptico' },
        { ar: 'شبكية العين',      en: 'Retina',                 es: 'Retina' },
        { ar: 'حاجب',             en: 'Eyebrow',                es: 'Ceja' },
        { ar: 'قطرات العين',      en: 'Eye Drops',              es: 'Gotas para los ojos' },
        { ar: 'نظارات طبية',      en: 'Medical Glasses',        es: 'Gafas Médicas' },
        { ar: 'عدسة',             en: 'Lens / Contact Lens',    es: 'Lente / Lente de contacto' },
        { ar: 'مرهم',             en: 'Ointment',               es: 'Ungüento' },
        { ar: 'لوحة فحص الرؤية',  en: 'Vision Test Chart',     es: 'Tabla de visión' },
        { ar: 'فحص طبي',          en: 'Medical Examination',    es: 'Examen médico' },
      ],
  ...
  // ==========================================
  {
    ...
    content: {
      ...
      vocab: [
        { ar: 'بَيت',     en: 'House',             es: 'Casa' },
        { ar: 'بُلبُل',   en: 'Nightingale',       es: 'Ruiseñor' },
        { ar: 'بُستان',   en: 'Garden',            es: 'Jardín' },
        { ar: 'بَصَل',    en: 'Onion',             es: 'Cebolla' },
        { ar: 'بِنت',     en: 'Girl',              es: 'Niña' },
        { ar: 'بُومة',    en: 'Owl',               es: 'Búho' },
        { ar: 'رَبيع',    en: 'Spring',            es: 'Primavera' },
        { ar: 'بَحر',     en: 'Sea',               es: 'Mar' },
        { ar: 'بَاب',     en: 'Door',              es: 'Puerta' },
        { ar: 'كَبير',    en: 'Big / Large',       es: 'Grande' },
        { ar: 'بِدَاية',  en: 'Beginning',         es: 'Comienzo' },
        { ar: 'بُنْدُق',  en: 'Hazelnut',          es: 'Avellana' },
        { ar: 'صَنبُور',  en: 'Faucet / Tap',      es: 'Grifo' },
        { ar: 'سَرير',    en: 'Bed',               es: 'Cama' },
        { ar: 'بَائع',    en: 'Seller / Vendor',   es: 'Vendedor' },
      ],
  ...
  // ==========================================
  {
    ...
    content: {
      ...
      vocab: [
        { ar: 'جسر / جسران',   en: 'Bridge / Two Bridges',         es: 'Puente / Dos puentes' },
        { ar: 'أسد / أسدان',   en: 'Lion / Two Lions',             es: 'León / Dos leones' },
        { ar: 'غيمة / غيمتان', en: 'Cloud / Two Clouds',           es: 'Nube / Dos nubes' },
        { ar: 'فراشة / فراستان', en: 'Butterfly / Two Butterflies', es: 'Mariposa / Dos mariposas' },
        { ar: 'نهر / نهران',   en: 'River / Two Rivers',           es: 'Río / Dos ríos' },
        { ar: 'قلم / قلمان',   en: 'Pen / Two Pens',               es: 'Bolígrafo / Dos bolígrafos' },
        { ar: 'بحر / بحران',   en: 'Sea / Two Seas',               es: 'Mar / Dos mares' },
        { ar: 'ثوب / ثوبان',   en: 'Garment / Two Garments',       es: 'Prenda / Dos prendas' },
        { ar: 'هاتف / هاتفان', en: 'Phone / Two Phones',           es: 'Teléfono / Dos teléfonos' },
        { ar: 'جورب / جوربان', en: 'Sock / Two Socks',             es: 'Calcetín / Dos calcetines' },
        { ar: 'طفل / طفلان',   en: 'Child / Two Children',         es: 'Niño / Dos niños' },
        { ar: 'نجمة / نجمتان', en: 'Star / Two Stars',             es: 'Estrella / Dos estrellas' },
        { ar: 'قبعة / قبعتان', en: 'Hat / Two Hats',               es: 'Sombrero / Dos sombreros' },
        { ar: 'جمل / جمالان',  en: 'Camel / Two Camels',           es: 'Camello / Dos camellos' },
      ],
  ...
  // ==========================================
  {
    ...
    content: {
      ...
      vocab: [
        { ar: 'قطرات العين',          en: 'Eye Drops',                    es: 'Gotas para los ojos' },
        { ar: 'نظارات طبية',          en: 'Medical Glasses / Spectacles',  es: 'Gafas médicas' },
        { ar: 'عدسة لاصقة',          en: 'Contact Lens',                  es: 'Lente de contacto' },
        { ar: 'مرهم',                 en: 'Ointment / Eye Cream',          es: 'Ungüento / Crema ocular' },
        { ar: 'لوحة فحص الرؤية',      en: 'Vision Test / Eye Chart',      es: 'Tabla de visión' },
        { ar: 'فحص طبي',              en: 'Medical Examination',           es: 'Examen médico' },
        { ar: 'جهاز باسكال الليزري',  en: 'Pascal Laser Device',           es: 'Dispositivo láser Pascal' },
        { ar: 'إبرة جراحة',           en: 'Surgical Needle',               es: 'Aguja quirúrgica' },
        { ar: 'طبيب',                 en: 'Doctor / Physician',            es: 'Médico / Doctor' },
        { ar: 'بؤبؤ',                 en: 'Pupil (of the eye)',            es: 'Pupila (del ojo)' },
        { ar: 'العصب البصري',         en: 'Optic Nerve',                   es: 'Nervio óptico' },
        { ar: 'شبكية العين',          en: 'Retina',                        es: 'Retina' },
        { ar: 'حاجب',                 en: 'Eyebrow',                       es: 'Ceja' },
        { ar: 'جفن',                  en: 'Eyelid',                        es: 'Párpado' },
        { ar: 'وصفة طبية',            en: 'Medical Prescription',          es: 'Receta médica' },
        { ar: 'مضادات الهيستامين',    en: 'Antihistamines',                es: 'Antihistamínicos' },
        { ar: 'كورتيزون',             en: 'Cortisone / Corticosteroid',    es: 'Cortisona / Corticosteroide' },
        { ar: 'كمادات',               en: 'Compresses / Cold Packs',       es: 'Compresas / Bolsas frías' },
      ],
